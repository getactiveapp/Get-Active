    ...
    var body: some View {
        NavigationView {
                    ...
                    VStack(spacing: 0) {
                        ...
                        VStack(alignment: .leading, spacing: 12) {
                            ...
                            VStack(spacing: 0) {
                                ...
                                SettingsRow(icon: "magnifyingglass", title: "Search Users", color: .getActiveRed) {
            ...
            .sheet(isPresented: $showingAnalytics) {
                // Show analytics for all events hosted by the current user
                // eventId is not used in AnalyticsView - it shows all user events
